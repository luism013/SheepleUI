angular.module('Sheeple').controller('LoginController', ['$http', '$log', '$scope', '$location', '$routeParams', 'currUser',
    function($http, $log, $scope, $location, $routeParams, currUser) {
        ...
        this.register = function(firstname, lastname, email, phone, gender, username, password){
